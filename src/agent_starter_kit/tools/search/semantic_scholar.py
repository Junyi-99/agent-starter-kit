...
class SemanticScholarSearchEngine(SearchEngine):
    ...
    async def search(self, query: str, year_from: int | str | None = None, year_to: int | str | None = None, offset: int | None = None, limit: int | None = None) -> list[PaperSearchResult]:
        ...
        } if SEMANTIC_SCHOLAR_API_KEY is not None else {}
